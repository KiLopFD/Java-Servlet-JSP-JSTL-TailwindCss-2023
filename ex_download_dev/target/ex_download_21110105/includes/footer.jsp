...
<footer class="bg-gray-900">
    ...
    <div class="px-4 py-6 bg-gray-100 bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© <c:out value="${currentDate}"></c:out> <a href="https://flowbite.com/">Designed by Ki Lop</a>. All Rights Reserved.
        </span>
